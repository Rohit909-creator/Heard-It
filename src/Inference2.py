...
# Mini Model of 21Mb
# checkpoint_path = "./lightning_logs/version_27/checkpoints/epoch=9-step=31040.ckpt" #Less score for sam wakeword, but all else good
checkpoint_path = "./lightning_logs/version_27/checkpoints/epoch=14-step=46560.ckpt" #Works on sam wakeword
...
mel_spec1 = load_and_preprocess_audio_file("./Audios4testing/kallan_2.wav", max_duration=1.0)
